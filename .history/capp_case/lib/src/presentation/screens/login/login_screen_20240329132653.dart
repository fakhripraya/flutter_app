...
class _LoginFormState extends State<LoginForm> {
  ...
  void _submitForm() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final emailField = formState.fields['email'] as _CAPPTextFormFieldState;
      final passwordField =
          formState.fields['password'] as _CAPPTextFormFieldState;

      final email = emailField.controller.text;
      final password = passwordField.controller.text;

      context.read<LoginBloc>().add(LoginDoLoginOrRegister(
