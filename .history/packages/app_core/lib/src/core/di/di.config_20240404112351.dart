...
import 'package:app_core/src/domain/auth/auth_interactor.dart' as _i12;
import 'package:app_core/src/domain/auth/auth_repository.dart' as _i5;
import 'package:app_core/src/domain/auth/auth_use_case.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.TransactionRemoteDataSource>(
        () => _i8.TransactionRemoteDataSourceImpl());
    gh.lazySingleton<_i9.TransactionRepository>(() =>
        _i10.TransactionRepositoryImpl(gh<_i7.TransactionRemoteDataSource>()));
    gh.lazySingleton<_i11.AuthUseCase>(
        () => _i12.AuthInteractor(gh<_i5.AuthRepository>()));
    gh.lazySingleton<_i13.TransactionUseCase>(
        () => _i14.TransactionInteractor(gh<_i9.TransactionRepository>()));
    return this;
  }
}
